...
import { AboutSection, BrandsAndCertificate, ContactSection, JsonLd, SitePage, siteUrl } from "@/components/site/public-site";

export const metadata: Metadata = {
  title: "Om EV-Check.dk | Certificeret elbil batteridiagnose",
  description:
