...
export const metadata: Metadata = {
  ...
  description:
    "Tak for din booking eller henvendelse til EV-Check.dk. Vi vender tilbage hurtigst muligt.",
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl rounded-3xl border border-white/70 bg-white p-8 text-center shadow-sm shadow-slate-200/70">
          ...
          <p className="mt-4 text-lg leading-8 text-slate-600">
            Din forespørgsel er registreret. Vi vender tilbage hurtigst muligt
            med bekræftelse på tid og praktisk information om batteritesten.
          </p>
